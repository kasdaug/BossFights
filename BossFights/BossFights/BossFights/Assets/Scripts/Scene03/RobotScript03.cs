...
public class RobotScript03 : MonoBehaviour
{
    ...
    public bool robotOnTheShark = false;
       ...
       if(col.gameObject.tag=="Bullet")
        {
            ...
            else
            {
                ...
                Destroy(col.gameObject);
                Destroy(gameObject);
                GameObject.Find("SharkBoss Fight").GetComponent<Fight>().robotIsDead = true;
            }
        }
    }
    ...
    void OnCollisionEnter2D(Collision2D col)
    {
        ...
        {
            robotOnTheShark = true;
        }
        else
        {
            robotOnTheShark = false;
        }
    }
