...
public class RobotScript2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sharedMaterial = p1box.GetComponent<Renderer>().material;
        p = leftStone.GetComponent<Renderer>().material;
        ...
        /*
        q.Equals("Sandy Orange") ||
        q.Equals("Brown Stony") ||
        q.Equals("Grass") ||
        q.Equals("Brown Stony Light") ||
        q.Equals("Water Light Blue") ||
        q.Equals("Default-Material"))
        */
    ...
    void OnCollisionEnter2D(Collision2D col)
    {
        ...
        {
            robotOnTheRightBox = true;
            Debug.Log("P1 - the right box");
        }
        else
        {
            robotOnTheRightBox = false;
            Debug.Log("P1 - not the right box");
        }
    }
